...
public static $passwordMustBeAlphaNumeric = "Your password can only contain numbers and letters";
...
public static $yardNameCharacters = "Your yard name must be between 2 and 25 characters";
